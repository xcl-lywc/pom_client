          ...
          <el-row>
            <el-table
              ...
              <div v-if="activeName=='first'">
                ...
                <el-table-column prop="planBeginTime" label="月份" show-overflow-tooltip width="120"  align='center'>
                  <template slot-scope="scope">
                    {{common._convertDate(scope.row.planBeginTime, 'MM月')}}
                  </template>
                </el-table-column>
              ...
              <!-- <div v-if="activeName=='second'">
                ...
                <el-table-column prop="monthList" :label="common._convertDate(searchForm.dateTime, 'yyyy年')" show-overflow-tooltip width=""  align='center'>
                  <el-table-column v-if="tableData.total>0" v-for="(item,index) in tableData.rows[0].monthList" prop="money" :label="((index+1)<10?'0'+(index+1):(index+1))+'月'" show-overflow-tooltip width=""  align='center'>
                    <template slot-scope="scope">
                      <div v-for="(itemC,indexC) in tableData.rows[scope.$index].monthList">{{itemC.money?itemC.money+'元':''}}</div>
                    </template>
                  </el-table-column>
                </el-table-column>
