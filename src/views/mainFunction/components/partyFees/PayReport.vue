      ...
      <div>
        ...
        <el-card class="marb20">
          <el-form :inline="true" :model="searchForm" ref="searchForm" size="small">
            <el-form-item label="缴纳时间" prop="dateTime">
              <el-date-picker
        ...
        <el-card class="marb20" v-loading="isLoad">
          <div slot="header" class="clearfix marb15">
            <span :class="{'el-card-have-border-span':false}">党费缴纳报告单</span>  
          ...
          <el-row>
            <el-table
              ...
              <el-table-column prop="name2" width="180"></el-table-column>
              <el-table-column prop="amount2"></el-table-column>
              <el-table-column prop="name3" width="180"></el-table-column>
              <el-table-column prop="amount3"></el-table-column>
            </el-table>
            <!-- <el-row :gutter="20" v-if="tableDatas">
              <el-form class="text-bold mart10">
                <el-col :span="12" :offset="0">
                  <el-form-item label="党支部经办人：">{{tableDatas.charger}}</el-form-item>
                </el-col>
                <el-col :span="12" :offset="0">
                  <el-form-item label="党群部签收人：">{{tableDatas.signatory}}</el-form-item>
                </el-col>
              </el-form>
            </el-row> -->
          </el-row>
