...
<template>
  <el-row>
      ...
      <div class="content-wrap-box">
        <el-card class="content-title-card" shadow="never">
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>党费收缴</el-breadcrumb-item>
            <el-breadcrumb-item>党费收缴使用管理情况</el-breadcrumb-item>
          </el-breadcrumb>
        </el-card>
        <div class="theme-main"> 
          ...
          <el-card class="marb20" v-loading="isLoad">
            <div slot="header" class="clearfix marb15">
              <span class="el-card-have-border-span">党费收缴使用管理情况</span>  
            ...
            <el-row>
              <el-table
                ...
                <el-table-column prop="userId" label="姓名" show-overflow-tooltip width="120"  align='center'></el-table-column>
                ...
                <el-table-column prop="payRatio" label="缴纳比例" show-overflow-tooltip width="100"  align='center'></el-table-column>
    ...
    <!-- 创建/编辑 -->
    <el-dialog :title="dialogType=='edit'?'编辑':'创建'" :visible.sync="dialogVisible" width="800px">
      <el-form ref="dialogForm"  :model="dialogForm" label-width="120px" v-loading="dialogLoading">
        <el-row>
          <el-col :span="12">
            <el-form-item 
              label="核定人：" prop="userId"
              :rules="[
                { required: true, message: '请选择核定人', trigger: 'change' }
              ]">
              <!-- <el-input :maxlength="20" :show-word-limit="false" v-model="dialogForm.jobName" placeholder="姓名"></el-input> -->
              <el-select v-model="dialogForm.userId" placeholder="核定人">
          ...
          <el-col :span="12">
            <el-form-item 
              ...
              :rules="[
                { required: true, message: '请输入岗位工资', trigger: 'blur' },{ type: 'number', message: '必须为数字值'},
              ]">
              <el-input v-model.number="dialogForm.postWage" placeholder="岗位工资"><template slot="append">元</template></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item 
              ...
              :rules="[
                { required: true, message: '请输入保障工资', trigger: 'blur' },{ type: 'number', message: '必须为数字值'},
              ]">
              <el-input v-model.number="dialogForm.guaranteeWage" placeholder="保障工资"><template slot="append">元</template></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item 
              ...
              :rules="[
                { required: true, message: '请输入养老保险', trigger: 'blur' },{ type: 'number', message: '必须为数字值'},
              ]">
              <el-input v-model.number="dialogForm.endowmentInsurance" placeholder="养老保险"><template slot="append">元</template></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item 
              ...
              :rules="[
                { required: true, message: '请输入医疗保险', trigger: 'blur' },{ type: 'number', message: '必须为数字值'},
              ]">
              <el-input v-model.number="dialogForm.medicalInsurance" placeholder="医疗保险"><template slot="append">元</template></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item 
              ...
              :rules="[
                { required: true, message: '请输入失业保险', trigger: 'blur' },{ type: 'number', message: '必须为数字值'},
              ]">
              <el-input v-model.number="dialogForm.unemploymentInsurance" placeholder="失业保险"><template slot="append">元</template></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item 
              ...
              :rules="[
                { required: true, message: '请输入住房公积金', trigger: 'blur' },{ type: 'number', message: '必须为数字值'},
              ]">
              <el-input v-model.number="dialogForm.housingProvidentFund" placeholder="住房公积金"><template slot="append">元</template></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item 
              ...
              :rules="[
                { required: true, message: '请输入补贴', trigger: 'blur' },{ type: 'number', message: '必须为数字值'},
              ]">
              <el-input v-model.number="dialogForm.subsidies" placeholder="补贴"><template slot="append">元</template></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item 
              ...
              :rules="[
                { required: true, message: '请输入年终奖', trigger: 'blur' },{ type: 'number', message: '必须为数字值'},
              ]">
              <el-input v-model.number="dialogForm.annualBonus" placeholder="年终奖"><template slot="append">元</template></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item 
              ...
              :rules="[
                { required: true, message: '请输入个人所得税', trigger: 'blur' },{ type: 'number', message: '必须为数字值'},
              ]">
              <el-input v-model.number="dialogForm.individualIncomeTax" placeholder="个人所得税"><template slot="append">元</template></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item 
              ...
              :rules="[
                { required: true, message: '请输入缴纳基数', trigger: 'blur' },{ type: 'number', message: '必须为数字值'},
              ]">
              <el-input v-model.number="dialogForm.payNumber" placeholder="缴纳基数"><template slot="append">元</template></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item 
              ...
              <el-slider v-model="dialogForm.payRatio" :format-tooltip="formatTooltip" placeholder="缴纳比例"></el-slider>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item 
              ...
              :rules="[
                { required: true, message: '请输入缴纳金额', trigger: 'blur' },{ type: 'number', message: '必须为数字值'},
              ]">
              <el-input v-model.number="dialogForm.payMoney" placeholder="缴纳金额"><template slot="append">元</template></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item 
  ...
  export default {
    ...
    methods: { 
      ...
      edit(formName,data){
        ...
        this.dialogForm.ratifiedYear = String(JSON.parse(JSON.stringify(data)).ratifiedYear)
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            if(this.dialogType == 'add'){
              ...
              // form.ratifiedYear = Number(this.dialogForm.ratifiedYear)
              this.axios.put(`${this.common.basePath}/due`,form).then((response) => {
                this.$message.success(response.meta.message);
                this.query();
                this.bottonLoding = false;
                this.dialogVisible = false;
