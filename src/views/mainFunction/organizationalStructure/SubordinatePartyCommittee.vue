    ...
    <div class="content-wrap-box">
      <el-card class="content-title-card" shadow="never">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>下级党委</el-breadcrumb-item>
        </el-breadcrumb>
      </el-card>
      <div class="theme-main"> 
        <org-manage menuRequestUrll="org/children" orgType='1' partyNature='1' memberRequestUrll="org/partyCommitteeLeader"></org-manage>
      </div>
    </div>
  </div>
</template>
