...
<script> 
  ...
  export default {
    ...
    methods: {
       ...
       */
      getQueryDetailById(){ 
        this.axios.get(`${this.common.basePath}/article/${this.articleId}/detail?partyOrgId=${this.orgId}&userId=${this.accessKey}`, '').then((response) => {
      ...
      queryCommentList(){ 
        this.isLoad = true;
        this.axios.post(`${this.common.basePath}/article/review/list`, this.reviewSearchForm).then((response) => {
      ...
      like(){
        this.axios.get(`${this.common.basePath}/article/like?id=${this.articleId}&userId=${this.accessKey}`, '').then((response) => {
          this.getQueryDetailById();
      ...
      learn(){
        this.axios.get(`${this.common.basePath}/article/learn/${this.articleId}?userId=${this.accessKey}`, '').then((response) => {
          this.getQueryDetailById();
          this.$message.success(response.meta.message);
        }).catch((errorMsg) => { 
          this.$message.error(errorMsg)
       ...
       */
      submitReview(){   
        this.axios.post(`${this.common.basePath}/article/review`, this.commentForm).then((response) => {
          this.queryCommentList();
          this.$message.success(response.meta.message);
        }).catch((errorMsg) => { 
          this.$message.error(errorMsg)
      ...
      collect(){
        this.axios.post(`${this.common.basePath}/article/collect?id=${this.articleId}&userId=${this.accessKey}`, '').then((response) => {
          this.getQueryDetailById();
          this.$message.success(response.meta.message);
        }).catch((errorMsg) => { 
          this.$message.error(errorMsg)
